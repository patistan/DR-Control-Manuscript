function [Pair_data,selected_cells] = NatScene_decoding_ver8_for10_pooled_hard(ExpID,type,selected_cells,bins,folds)
...
for fold = 1:folds
    ...
    [RespMatrix,RespMatrixTraining,RespMatrixTesting,RespMatrixAllTrials,ProbDist,BinThresh,removedBlocks_new,selected_cells]=get_prob_dist_ver8_for10_pooled_hard(ExpID,selected_cells,bins,folds,fold,p);
